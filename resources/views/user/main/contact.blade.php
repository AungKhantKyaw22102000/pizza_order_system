        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    ...
                    @endif
                    <form method="post" action="{{ route('user#contactCreate') }}" novalidate="novalidate">
                        @csrf
                        ...
                        <div class="control-group my-2">
                            <input type="text" class="form-control" name="messageSubject" placeholder="Subject"
                                value="{{ old('messageSubject') }}" />
                            @error('messageSubject')
                                <p class="help-block text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="control-group my-2">
                            <textarea class="form-control" rows="8" name="messageInfo" placeholder="Message">{{ old('messageInfo') }}</textarea>
                            @error('messageInfo')
                                <p class="help-block text-danger">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="col-lg-5 mb-5">
                ...
                <div class="bg-light p-30 mb-3">
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Street, Dummy City, Dummy</p>
