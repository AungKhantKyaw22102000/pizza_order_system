        ...
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="row mt-2">
                            <div class="col-1 offset-10 bg-white shadow-sm p-2 mb-2 text-center">
                                <h3 class="text-secondary"><i class="fa-solid fa-database"></i> {{ $pizzas->total()}} </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive table-responsive-data2">
                        <table class="table table-data2 text-center">
                            ...
                            <tbody>
                                ...
                                <tr class="tr-shadow">
                                    <td class="col-2"><img src="{{ asset('storage/'.$pizza->image) }}" alt="" class=" img-thumbnail shadow-sm"></td>
                                    <td class="col-2">{{ $pizza->name }}</td>
                                    <td class="col-3">{{ $pizza->price }}</td>
                                    <td class="col-2">{{ $pizza->category_id }}</td>
                    ...
                    @else
                    <h3 class="text-secondary text-center mt-5">There is not Product Here!</h>
                    @endif
                    <!-- END DATA TABLE -->
                </div>
            </div>
